...
基于 **LangGraph + FastAPI + Next.js**，通过 Qwen2.5-7B 路由 Agent 将用户问题分发给学科答疑、学习规划、情绪疏导三大专项 Agent，并具备完整的链路追踪与故障恢复能力。
